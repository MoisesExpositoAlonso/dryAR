...
```{r read the image processed data}
...
```{r merge images with genotype replicates}
...
veg=veg %>%
  left_join(.,red,by=c('potindex')) %>%
  left_join(veg,green,by=c('site','qp','pos','trayid','rep','indpop','water','id', 'potindex'))
